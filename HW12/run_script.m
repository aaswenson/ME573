...
xlabel('x')
ylabel('v')
saveas(gcf,'./writeup/V_X.png')

% u(t)
figure(4)
plot(t, utrans)
title('transient u(x=0.14,y=0.08)')
xlabel('t')
ylabel('u')
saveas(gcf,'./writeup/U_trans.png')

% surface plots
% u velocity plot
figure(5)
surf(X,Y,u)
title('steady-state u(x,y)')
xlabel('x')
ylabel('y')
saveas(gcf,'./writeup/surf_U.png')

% v velocity plot
figure(6)
surf(X,Y,v)
title('steady-state v(x,y)')
xlabel('x')
ylabel('y')
saveas(gcf,'./writeup/surf_V.png')
